...
class ComposeResourcesService(private val project: Project) : Disposable {
    ...
    private fun detectSourceSet(filePath: String, composeResIdx: Int): String? {
    ...
    private fun detectSourceSetFromCustomPath(filePath: String, customPath: String): String? {
    ...
    companion object {
        ...
        fun getInstance(project: Project): ComposeResourcesService {
            return project.getService(ComposeResourcesService::class.java)
        }
    }
}
