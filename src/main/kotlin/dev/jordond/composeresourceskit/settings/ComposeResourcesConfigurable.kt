...
class ComposeResourcesConfigurableProvider(private val project: Project) : ConfigurableProvider() {
    override fun createConfigurable(): Configurable = ComposeResourcesConfigurable(project)
}

class ComposeResourcesConfigurable(private val project: Project) : Configurable {
